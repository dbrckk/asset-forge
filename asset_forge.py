...
def parser() -> argparse.ArgumentParser:
    ...
    generate.add_argument("--backend", choices=["auto", "pollinations", "imagen-codex", "qwen-colab", "cloudflare"], default="auto")
    ...
    produce.add_argument("--backend", choices=["auto", "pollinations", "imagen-codex", "qwen-colab", "cloudflare"], default="auto")
    ...
    fulfill.add_argument("--backend", choices=["auto", "pollinations", "imagen-codex", "qwen-colab", "cloudflare"], default="auto")
