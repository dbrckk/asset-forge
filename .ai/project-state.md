...
## Current priority
- Consider additional engine adapters and batching/rendering helpers; runtime-atlas now includes validated timeline event markers and deterministic web event dispatch.
...
## Last verified
- 2026-09-19: latest GitHub source inspected after adding validated animation event markers with optional payloads, schema/tests/example coverage, and deterministic onEvent dispatch across skipped frames and multiple loops.
