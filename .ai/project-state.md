...
## Current priority
- Consider additional engine adapters and higher-level scene systems; runtime-atlas now includes 32-bit entity layer masks, runtime/per-call visibility masks, pre-batch layer filtering, and visibility-aware batch-cache variants.
...
## Last verified
- 2026-09-19: latest GitHub source inspected after adding unsigned 32-bit layerMask validation, filterSpriteInstancesByLayer(), hierarchy-aware visibility filtering before culling/batching, canvas-runtime visibilityMask/setVisibilityMask(), per-call overrides, and visibility-mask-aware entity batch caching.
