...
## Current priority
- Consider additional engine adapters and higher-level scene systems; runtime-atlas now includes parent-child world transforms with position/scale/depth/rotation inheritance, per-sprite pivots, rotation-aware culling, and classic/instanced rotated rendering.
...
## Last verified
- 2026-09-19: latest GitHub source inspected after extending sprite entities/instances with radians rotation and logical pivots, rotating child local offsets through parent transforms, expanding instanced records to 16 floats/64 bytes, adding shader pivot rotation, rotating classic quads, and making culling bounds rotation-aware.
