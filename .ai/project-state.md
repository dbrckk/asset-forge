...
## Current priority
- Consider additional engine adapters, animation-to-entity binding, and higher-level scene systems; runtime-atlas now includes a persistent validated sprite entity store integrated with batching/rendering and resilient across WebGL2 context reconstruction.
...
## Last verified
- 2026-09-19: latest GitHub source inspected after adding createSpriteEntityStore() with stable IDs, add/update/remove/clear, immutable snapshots, enabled filtering, versioning, transactional rollback, canvas-runtime buildEntityBatches()/renderEntities(), and persistence across WebGL2 context loss/restoration.
