...
## Current priority
- Consider additional engine adapters and higher-level scene/entity ergonomics; runtime-atlas now includes HiDPI canvas resizing plus WebGL2 context-loss detection and full GPU scene/resource reconstruction on restore.
...
## Last verified
- 2026-09-19: latest GitHub source inspected after adding HiDPI canvas resize/viewport management and createWebGL2CanvasRuntime(), which handles webglcontextlost/restored, prevents rendering while lost, recreates scene/shaders/buffers/textures on restore, and exposes explicit restore/wait/dispose lifecycle.
