...
## Current priority
- Consider additional engine adapters, browser image-loading convenience helpers, and higher-level scene integration; runtime-atlas now includes deterministic multi-atlas batching, a functional WebGL2 instanced renderer, and reference-counted/deduplicated texture lifetime management.
...
## Last verified
- 2026-09-19: latest GitHub source inspected after adding a WebGL2 texture cache with configurable upload parameters, reference counting, acquire/release/delete/clear/dispose lifecycle, deduplicated async loads, disposal-safe pending loads, tests, and renderer integration documentation.
