...
## Current priority
- Consider additional engine adapters and higher-level scene systems; runtime-atlas now includes parent-child entity transform hierarchies with recursive world-space position/scale/depth resolution, disabled-state propagation, cycle/missing-parent validation, and cache-aware rendering.
...
## Last verified
- 2026-09-19: latest GitHub source inspected after adding parent-child sprite entity transforms, recursive world-space resolution, inherited scale/depth/disabled state, cycle and missing-parent validation, entity-render integration, and automatic version-aware batch-cache invalidation when ancestors change.
