...
## Current priority
- Consider additional engine adapters, animation event markers, and batching/rendering helpers; runtime-atlas web playback now includes deterministic controller state and lifecycle callbacks.
...
## Last verified
- 2026-09-19: latest GitHub source inspected after adding a deterministic web animation controller with play/pause/seek/playback-rate, frame/loop/finish callbacks, and direct Canvas2D player drawing.
