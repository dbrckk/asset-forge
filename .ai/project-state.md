...
## Current priority
- Consider additional engine adapters and higher-level scene systems; runtime-atlas now includes zoom-aware world-bounds camera clamping, centered handling for worlds smaller than the viewport, and direct hierarchy-resolved entity following with configurable focus offsets.
...
## Last verified
- 2026-09-19: latest GitHub source inspected after adding clampCameraToWorldBounds(), zoom-aware viewport-to-world clamp math, runtime worldBounds/setWorldBounds(), clamping after set/follow/shake, direct updateCameraFollowEntity() using hierarchy-resolved world coordinates, and follow offsets.
