...
## Current priority
- Consider additional engine adapters and higher-level scene systems; runtime-atlas now includes DOM-independent pointer/touch interaction with hover enter/leave, click discrimination, pointer capture metadata, drag lifecycle, multi-pointer state, and world-coordinate callbacks.
...
## Last verified
- 2026-09-19: latest GitHub source inspected after adding createSpritePointerInteractionController() with hover enter/leave, down/up/click, drag threshold/start/update/end, pointer capture metadata, multi-pointer tracking, cancel/clear, world-coordinate conversion, and canvas-runtime pointerMove()/pointerDown()/pointerUp()/pointerCancel() wired to normal entity picking.

<!-- AUTO:START -->
## Automatic repository state

Generated: 2026-09-19T14:21:59Z

### Git
- Branch: `main`
- Head: `ea64c29ee468`
- Commit date: 2026-09-19T16:21:51+02:00
- Commit: docs: record entity picking milestone
- Tracked files: 209
