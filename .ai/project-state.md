...
## Current priority
- Consider additional engine adapters and higher-level scene systems; runtime-atlas now includes inherited per-sprite RGB tint/alpha, 20-float instanced records, fragment modulation, and default standard alpha blending without splitting texture batches.
...
## Last verified
- 2026-09-19: latest GitHub source inspected after adding normalized per-sprite tintR/tintG/tintB/alpha, multiplicative hierarchy inheritance, aTint shader modulation, 20-float/80-byte instanced records, and optional standard SRC_ALPHA/ONE_MINUS_SRC_ALPHA renderer blending.
