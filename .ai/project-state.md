...
## Current priority
- Consider additional engine adapters and higher-level scene systems; runtime-atlas now includes hierarchy-safe world-space entity dragging, optional pointer auto-move, zoom-aware screen-delta conversion, X/Y axis constraints, and natural entity-version cache invalidation.
...
## Last verified
- 2026-09-19: latest GitHub source inspected after adding moveSpriteEntityByWorldDelta() with inverse parent rotation/scale conversion, runtime moveEntityByWorldDelta(), opt-in pointerOptions.autoDragEntities, dragAxis constraints, zoom-aware pointer drag conversion, and draggedEntity callback payloads.
